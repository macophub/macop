...
import (
	...
	"github.com/macophub/macop/format"
...
func (b *blobUpload) Prepare(ctx context.Context, requestURL *url.URL, opts *registryOptions) error {
	...
	if b.From != "" {
		...
		values.Add("from", ParseMCPPath(b.From).GetNamespaceRepository())
...
func uploadBlob(ctx context.Context, mp MCPPath, layer Layer, opts *registryOptions, fn func(api.ProgressResponse)) error {
